...
func convertHandler(c *gin.Context) {
	...
	// Debugging: Ensure LibreOffice is available
	_, err = exec.LookPath("libreoffice")
	if err != nil {
		log.Println("LibreOffice not found:", err)
		c.JSON(http.StatusInternalServerError, gin.H{"error": "LibreOffice is not installed"})
		return
	}
	...
	log.Println("LibreOffice Output:", string(output))
